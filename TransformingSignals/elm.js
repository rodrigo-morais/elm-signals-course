...
Elm.Main.make = function (_elm) {
   ...
   var isDigit = A2($Signal.map,$Char.isDigit,characters);
   var main = A2($Signal.map,$Graphics$Element.show,isDigit);
   return _elm.Main.values = {_op: _op,characters: characters,isDigit: isDigit,main: main};
};
