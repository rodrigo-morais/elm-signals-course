...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var view = F2(function (width,x) {    var side = _U.cmp(x,width / 2 | 0) < 0 ? "Left" : "Right";return $Graphics$Element.show(side);});
   var main = A3($Signal.map2,view,$Window.width,$Mouse.x);
