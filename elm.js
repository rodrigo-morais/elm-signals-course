...
Elm.Main.make = function (_elm) {
   ...
   var update = F2(function (character,model) {    return A2($Basics._op["++"],model,$String.fromChar(character));});
   var initialModel = "";
   var model = A3($Signal.foldp,update,initialModel,characters);
   var main = A2($Signal.map,view,model);
   return _elm.Main.values = {_op: _op,initialModel: initialModel,update: update,characters: characters,model: model,view: view,main: main};
};
