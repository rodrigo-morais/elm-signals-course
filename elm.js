...
Elm.SpaceShip.make = function (_elm) {
   ...
   var drawGame = F2(function (width,height) {    return A2($Graphics$Collage.filled,$Color.gray,A2($Graphics$Collage.rect,width,height));});
   var view = F2(function (_p0,ship) {
      var _p1 = _p0;
      var _p2 = {ctor: "_Tuple2",_0: 400,_1: 400};
      var width = _p2._0;
      var height = _p2._1;
      var _p3 = {ctor: "_Tuple2",_0: $Basics.toFloat(width),_1: $Basics.toFloat(height)};
      var width$ = _p3._0;
      var height$ = _p3._1;
      return A3($Graphics$Collage.collage,
      width,
      height,
      _U.list([A2(drawGame,width$,height$),A2(drawShip,height$,ship),$Graphics$Collage.toForm($Graphics$Element.show(ship))]));
   });
   ...
   var fire = function () {    var spaces = A2($Signal.map,Fire,$Keyboard.space);var delta = $Time.fps(30);return A2($Signal.sampleOn,delta,spaces);}();
