...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var fps = A2($Signal.map,$Time.inSeconds,$Time.fps(15));
   var fpsPosition = A2($Signal.sampleOn,fps,$Mouse.position);
   var main = A2($Signal.map,$Graphics$Element.show,fpsPosition);
   return _elm.Main.values = {_op: _op,fps: fps,fpsPosition: fpsPosition,main: main};
};
